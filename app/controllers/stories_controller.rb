class StoriesController < ApplicationController
	...
	def index
		@stories = Story.where(story_id: nil).order("created_at DESC") #Only show top level stories
	end
	...
	private
		def story_params
			params.require(:story).permit(:title, :content, :story_id, :user_id, :published)
		end
end
